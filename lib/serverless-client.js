...
// (5.4 min queued waiting for a worker + 4.8 min downloading/loading the model + answering) --
// the job actually completed on RunPod's side, just a few seconds after this used to give up at
// exactly 10 minutes and report a false failure to the user. 15 minutes gives real headroom above
// the observed worst case instead of racing it.
