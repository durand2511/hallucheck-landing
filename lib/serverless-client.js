...
// Same surface as modal-client.js so the route-level client switch stays a one-liner. RunPod
// Serverless has no batch route on this endpoint, so this stays sequential -- correct, not faster.
...
// RunPod's own scaler owns worker warm-up; there's no equivalent nudge to send from here.
module.exports = { analyzeDocument, analyzeBatch, warmUp: () => {}, getStatus };
